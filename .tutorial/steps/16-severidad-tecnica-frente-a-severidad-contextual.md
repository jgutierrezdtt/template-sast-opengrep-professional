...
- Campo o seccion objetivo: relacionado con "Severidad tecnica frente a severidad contextual".
- Ubicacion principal: `rules/security-rules.yml`.
- Resultado esperado: que la configuracion refleje el control del paso 16.

## Checklist de configuracion

- El cambio del paso 16 esta presente en `rules/security-rules.yml`.
