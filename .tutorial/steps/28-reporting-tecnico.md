...
- Resultado esperado: que la configuracion refleje el control del paso 28.

## Checklist de configuracion

- El cambio del paso 28 esta presente en `.github/workflows/sast.yml`.
...
- `scripts/validate-step-28.py` valida que el control de este paso esta aplicado.
- El estado de progreso se refleja en `.tutorial/state.json`.

## Criterio de finalizacion

El paso 28 se marca como completado cuando GitHub Actions reporta exito para `validate-step-28.py`.
