...
- El validador `scripts/validate-step-26.py` comprueba el estado esperado para este paso.
...
- Estado del paso en evidencia automatica: `.tutorial/evidence/step-26.json`.
- Coherencia de progresion en: `.tutorial/state.json`.

## Criterio de finalizacion automatica

El paso 26 queda completado cuando el workflow reporta exito para `validate-step-26.py` en GitHub Actions.

Siguiente paso automatico: Paso 27.
