...
Implementaras este control de SAST de forma concreta sobre el archivo `docs/sast-programa.md` y registraras evidencia tecnica en `.tutorial/evidence/step-24.json`.
...
{
  "step": 24,
  "title": "Reglas prohibidas por organizacion",
  "status": "completed",
