...
- Campo o seccion objetivo: relacionado con "Medalla final sast professional".
- Ubicacion principal: `.github/workflows/sast.yml`.
- Resultado esperado: que la configuracion refleje el control del paso 30.

## Checklist de configuracion

- El cambio del paso 30 esta presente en `.github/workflows/sast.yml`.
...
- `scripts/validate-step-30.py` valida que el control de este paso esta aplicado.
- El estado de progreso se refleja en `.tutorial/state.json`.

## Criterio de finalizacion

El paso 30 se marca como completado cuando GitHub Actions reporta exito para `validate-step-30.py`.
